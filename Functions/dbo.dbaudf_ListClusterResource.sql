...
SET ANSI_NULLS OFF
GO
CREATE FUNCTION [dbo].[dbaudf_ListClusterResource] ()
RETURNS TABLE (
...
EXTERNAL NAME [${{secrets.COMPANY_NAME}}.Operations.CLRTools].[${{secrets.COMPANY_NAME}}.Operations.UserDefinedFunctions].[dbaudf_ListClusterResource]
GO
