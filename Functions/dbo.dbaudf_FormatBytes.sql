...
SET ANSI_NULLS ON
GO
CREATE   FUNCTION [dbo].[dbaudf_FormatBytes]
(
...
END
-- EXAMPLES:
-- SELECT DBAOps.dbo.dbaudf_FormatBytes(22345,'Bytes')
-- SELECT DBAOps.dbo.dbaudf_FormatBytes(8675309,'MB')
-- SELECT DBAOps.dbo.dbaudf_FormatBytes(0.5,'GB')
GO
