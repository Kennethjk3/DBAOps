...
SET ANSI_NULLS ON
GO
CREATE   FUNCTION [dbo].[dbaudf_Translate_APP_NAME]
	(
...
AS
	...
	SELECT DBAOps.[dbo].[dbaudf_Translate_APP_NAME] ('',DEFAULT)
	SELECT DBAOps.[dbo].[dbaudf_Translate_APP_NAME] ('','JobID')
	SELECT DBAOps.[dbo].[dbaudf_Translate_APP_NAME] ('','JobName')
	SELECT DBAOps.[dbo].[dbaudf_Translate_APP_NAME] ('','StepID')
	SELECT DBAOps.[dbo].[dbaudf_Translate_APP_NAME] ('','StepName')
