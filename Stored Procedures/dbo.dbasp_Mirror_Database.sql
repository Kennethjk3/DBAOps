...
, ENCRYPTION = REQUIRED ALGORITHM RC4)'
	...
	EXEC master.dbo.sp_addlinkedsrvlogin @rmtsrvname = N'DYN_DBA_RMT', @locallogin = N'AMER\s-sledridge', @useself = N'False', @rmtuser = N'LinkedServer_User', @rmtpassword = N'4vnetonly'
