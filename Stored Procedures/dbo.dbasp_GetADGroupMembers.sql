...
from		openquery	(ADSI,'SELECT cn, distinguishedName FROM ''LDAP://DC=${{secrets.COMPANY_NAME}},DC=com'' WHERE objectCategory = ''group''')
WHERE		cn = @groupName
...
FROM ''''LDAP://DC=${{secrets.COMPANY_NAME}},DC=com''''
