...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[dbasp_SelfHeal_SQLdeploy]
...
Print  ' '
Print  '/*******************************************************************'
Select @miscprint = 'Starting: dbasp_SelfHeal_SQLdeploy'
Print  @miscprint
...
FOR
select distinct drivename from dbo.dba_diskinfo where active = 'y' and drivename <> 'c'
...
label99:
GO
GRANT EXECUTE ON  [dbo].[dbasp_SelfHeal_SQLdeploy] TO [public]
GO
