...
/**************************************************************
 **  Stored Procedure dbasp_SQL_Server_System_Report
 **  Written by unknown
 **  Dtae: unknown
 **
...
--	Date		Author     		Desc
--	==========	====================	=============================================
--	10/10/2011	Steve Ledridge		Found on seapsqldploy02.
...
EXECUTE [DBAOps].[dbo].[dbasp_FileAccess_Write] @vBody,@Path,0,1
GO
GRANT EXECUTE ON  [dbo].[dbasp_SQL_Server_System_Report] TO [public]
GO
